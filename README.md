...
### 1. Positioning Autopsy

**"Why does everything feel so hard?"** → Your positioning is broken.

What would happen if you didn't exist? Most founders position against competitors. This skill forces you to start from the status quo — spreadsheets, interns, "do nothing." Then builds upward through April Dunford's 5-component sequential framework, layers on Andy Raskin's strategic narrative, and validates with Emily Tate's PMF lens.
...
**"Why aren't we growing?"** → You're optimizing the wrong metric.
...
### 3. Behavioral Product Design

**"Why don't users do what we expect?"** → You designed for rational humans.

Replaces "let's interview 5 users" with behavioral science. Maps every real-world step a person takes to reach a behavior you want to change — including steps outside your product. If you're designing for "increase engagement," you haven't defined a behavior yet.
...
**"Why does our strategy feel hand-wavy?"** → You haven't decomposed it.
...
### 5. Vibe-to-Ship Coach

**"Why haven't we shipped yet?"** → You're over-planning, under-building.

The anti-planning skill. Step-by-step methodology for going from messy idea to working prototype using AI coding tools. Includes tool selection (Bolt vs. Lovable vs. Replit vs. Cursor), the "don't write any code" debugging method, and the frontend-first mock data strategy.
...
**"How do I actually use AI beyond ChatGPT?"** → Think workflows, not chat.
...
|---|---|
| "Everything feels hard, nothing clicks" | Positioning Autopsy |
| "We have users but aren't growing" | Growth Loop Diagnostics |
| "Users don't do what we designed for" | Behavioral Product Design |
| "Our strategy sounds good but goes nowhere" | Rigorous Thinking Coach |
| "We've been planning for weeks" | Vibe-to-Ship Coach |
| "I use ChatGPT but that's it" | AI Teammate Coach |
